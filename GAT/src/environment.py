...
if __name__ == "__main__":
    tau = 0.2  # sampling period (s) : 200ms
    env = Environment(bounds=(0.0, 4.0, 0.0, 3.0))

    # Single robot: (0.5, 0.5) -> (3.5, 2.5)
    ...
    plt.tight_layout()
    plt.savefig('../plots/phase1_2_dynamics.png', dpi=150)
    plt.show()
    print("Dynamics demo saved: plots/phase1_2_dynamics.png")
